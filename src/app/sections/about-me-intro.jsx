...
export default function AboutMeIntro() {
  ...
  const shouldReduceAnimations = isMobile || (typeof window !== 'undefined' && window.matchMedia('(prefers-reduced-motion: reduce)').matches)

  useEffect(() => {
    // Disable animations on desktop for performance
    const shouldReduceAnimations = isMobile || (typeof window !== 'undefined' && window.matchMedia('(prefers-reduced-motion: reduce)').matches)
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          animation: shouldReduceAnimations ? 'none' : 'rotateFloat 20s linear infinite',
          filter: 'blur(1px)',
        ...
        <div style={{
          ...
          borderRadius: '50%',
          animation: shouldReduceAnimations ? 'none' : 'rotateFloat 25s linear infinite reverse',
          filter: 'blur(2px)',
          display: shouldReduceAnimations ? 'none' : 'block',
        }}></div>
        ...
        <div style={{
          ...
          animation: shouldReduceAnimations ? 'none' : 'morphBounce 8s ease-in-out infinite',
          display: shouldReduceAnimations ? 'none' : 'block',
        }}></div>
        ...
        <div style={{
          ...
          animation: shouldReduceAnimations ? 'none' : 'morphBounce 6s ease-in-out infinite reverse',
          display: shouldReduceAnimations ? 'none' : 'block',
        }}></div>
        ...
        {/* Interactive Cursor Effect - Desktop only, disabled for performance */}
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  borderRadius: '2px',
                  margin: '0 auto 25px',
                  animation: shouldReduceAnimations ? 'none' : 'expandContract 2s ease-in-out infinite',
                }}></div>
