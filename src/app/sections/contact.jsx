    ...
    <div>
      ...
      >
        ...
        <div style={{
          ...
          {/* Code-like floating elements - Disabled on desktop for performance */}
          {!shouldReduceAnimations && [...Array(getResponsiveValue(6, 4, 3))].map((_, i) => (
            <div
              key={`code-${i}`}
              style={{
                position: 'absolute',
          ...
          {/* Matrix Rain Effect - Disabled on desktop for performance */}
          {!shouldReduceAnimations && [...Array(getResponsiveValue(8, 6, 4))].map((_, i) => (
            <div
              key={`matrix-${i}`}
          ...
          {/* Holographic Grid - Disabled on desktop for performance */}
          {!shouldReduceAnimations && (
          <div
          ...
          {/* Animated Geometric Shapes - Disabled on desktop for performance */}
          {!shouldReduceAnimations && (
          ...
          {/* Morphing Blob - Disabled on desktop for performance */}
          {!shouldReduceAnimations && (
          <div style={{
            position: 'absolute',
          ...
          {/* Floating particles - Disabled on desktop for performance */}
          {!shouldReduceAnimations && [...Array(getResponsiveValue(6, 4, 3))].map((_, i) => (
            <div key={i} style={{
              position: 'absolute',
              top: `${20 + i * 15}%`,
