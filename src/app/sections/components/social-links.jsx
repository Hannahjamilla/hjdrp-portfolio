  ...
  const socialIcons = {
    portfolio: (
      <svg width={getResponsiveValue(20, 18, 16)} height={getResponsiveValue(20, 18, 16)} viewBox="0 0 24 24" fill="currentColor">
        <path d="M3 3a2 2 0 012-2h3.28a1 1 0 00.948.684l.498 1.493a1 1 0 00.502.331h2.484c.164 0 .324-.04.464-.115l.498-1.49a1 1 0 00.947-.684H19a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V3z"/>
